 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 25, 60 }  // Ender Configs
...
#define Z_CLEARANCE_BETWEEN_PROBES  3 // Z Clearance between probe points  // MRiscoC Increase probe compatibility
...
#define HOMING_FEEDRATE_MM_M { (100*60), (100*60), (10*60) }  // MRiscoC Homing speed-up
